...
router.get('/api/alumnos/:id', async (req, res) => {
    ...
    const db = await connect()
    const result = await db.collection('alumnos').findOne({
        _id: ObjectID(id)
    })
    res.json(result)
})
...
router.get('/api/profesores/:id', async (req, res) => {
    ...
    const db = await connect()
    const result = await db.collection('profesores').findOne({
        _id: ObjectID(id)
    })
    res.json(result)
})
...
router.get('/api/centros/:id', async (req, res) => {
    ...
    const db = await connect()
    const result = await db.collection('centros').findOne({
        _id: ObjectID(id)
    })
    res.json(result)
})
...
router.delete('/api/alumnos/:id', async (req, res) => {
    ...
    const db = await connect()
    const result = await db.collection('alumnos').deleteOne({
        _id: ObjectID(id)
    })
    res.json({
...
router.delete('/api/profesores/:id', async (req, res) => {
    ...
    const db = await connect()
    const result = await db.collection('profesores').deleteOne({
        _id: ObjectID(id)
    })
    res.json({
...
router.delete('/api/centros/:id', async (req, res) => {
    ...
    const db = await connect()
    const result = await db.collection('centros').deleteOne({
        _id: ObjectID(id)
    })
    res.json({
...
router.get('/deleteprofesores/:id', async (req, res) => {
    ...
    const db = await connect()
    await db.collection('profesores').deleteOne({
        _id: ObjectID(id)
    })
...
router.get('/deletecentros/:id', async (req, res) => {
    ...
    const db = await connect()
    await db.collection('centros').deleteOne({
        _id: ObjectID(id)
    })
